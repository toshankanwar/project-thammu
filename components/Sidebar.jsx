...
export default function SidebarWithToggler({ closeSidebar }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static top-0 left-0 z-50 md:z-10 h-full md:h-[calc(100vh-4rem)] w-64 bg-gray-100 shadow-md border-r border-gray-300 transition-transform duration-300 transform ${
