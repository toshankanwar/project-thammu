  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-8 lg:px-20 font-sans">
      <div className="group max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-6 sm:p-10 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_8px_40px_rgba(59,130,246,0.35)] animate-fade-in-up">
        ...
        {/* Header */}
        <h1 className="text-4xl font-semibold text-center text-black mb-6 tracking-wide">
          About
        </h1>
        <p className="text-center text-lg text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed font-normal">
        ...
        <div className="bg-gray-50 rounded-lg py-4 px-6 mb-10 shadow-sm text-center transform transition duration-300 hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(59,130,246,0.4)]">
          <p className="text-lg text-gray-800 font-normal mb-2">A few words from the poet...</p>
          <p className="text-base italic text-gray-500 max-w-xl mx-auto leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div>
            <h2 className="text-3xl font-semibold text-black mb-4">Meet</h2>
            <p className="text-base text-gray-700 mb-4 leading-relaxed font-light">
              My name is Thaneshwar Sahu, and I’ve been writing poetry since I could remember. Poetry is my voice, my personal reflection on the world around me.
            </p>
            <p className="text-base text-gray-700 mb-4 leading-relaxed font-light">
              Each poem I write speaks to different moments of life—joy, sorrow, nature, and love. These poems are a piece of my journey.
            </p>
        ...
        {/* Journey Section */}
        <div className="mt-16">
          <h2 className="text-3xl font-semibold text-black mb-4">The Journey of a Poet</h2>
          <p className="text-base text-gray-600 mb-4 leading-relaxed font-light">
            My journey as a poet has been filled with moments of deep reflection and growth. Each poem is a step forward in my personal exploration of the world.
          </p>
          <p className="text-base text-gray-600 leading-relaxed font-light">
            I began writing in my youth, finding solace and meaning through my words. Over the years, poetry has become a vital part of me.
          </p>
        </div>

        {/* Social Media */}
        <div className="text-center mt-14">
          <p className="text-lg text-gray-600 mb-4 font-normal">Stay connected and join me on this poetic journey:</p>
        ...
        {/* CTA */}
        <div className="text-center mt-14">
          <p className="text-base text-gray-600 mb-4 font-normal">Want to read more? Explore my latest poems.</p>
          <Link
            href="/poem"
